...
const glbModel = require('./computers_1-transformed.glb')
/*
...
export function Computers(props) {
  const { nodes: n, materials: m } = useGLTF(glbModel)
...
function ScreenText({ invert, x = 0, y = 1.2, ...props }) {
  ...
  return (
    <Screen {...props}>
      ...
      <Text position={[x, y, 0]} ref={textRef} fontSize={4} letterSpacing={-0.1} color={!invert ? 'black' : '#35c19f'}>
        Poimandres.
      </Text>
    </Screen>
  )
